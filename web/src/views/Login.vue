  ...
  methods: {
    ...
    handleLogin(response) {
      ...
      if (response.code == 0) {
        ...
        // response.result.icon="data:image/jpeg;base64,"+response.result.icon;
    ...
    goToLoginG() {
      ...
      "http://github.com/login/oauth/authorize?client_id=51f0dde36e2f4fcee97c&redirect_uri=http://localhost:9092/oauth/github";
...
// );
//       axios
//         .get("http://github.com/login/oauth/authorize?client_id=51f0dde36e2f4fcee97c&redirect_uri=http://localhost:9092/oauth/github",
//             {}
//         )
