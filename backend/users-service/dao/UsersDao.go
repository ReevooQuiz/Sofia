...
type UsersDao interface {
	...
	InsertApproveAnswer(ctx TransactionContext, approveAnswer entity.ApproveAnswers) (err error)
	...
	InsertFavoriteItem(ctx TransactionContext, favoriteItem entity.FavoriteItems) (err error)
	...
	InsertLikeAnswer(ctx TransactionContext, likeAnswer entity.LikeAnswers) (err error)
	...
	RemoveApproveAnswerByUidAndAid(ctx TransactionContext, uid int64, aid int64) (err error)
	RemoveBanWordByWord(ctx TransactionContext, word string) (err error)
	RemoveFavoriteItemByFidAndQid(ctx TransactionContext, fid int64, qid int64) (err error)
	RemoveFollowByUidAndFollower(ctx TransactionContext, uid int64, follower int64) (err error)
	RemoveLikeAnswerByUidAndAid(ctx TransactionContext, uid int64, aid int64) (err error)
	RemoveUserLabelsByUid(ctx TransactionContext, uid int64) (err error)
	UpdateAnswerByAid(ctx TransactionContext, answer entity.Answers) (err error)
	UpdateQuestionByQid(ctx TransactionContext, question entity.Questions) (err error)
